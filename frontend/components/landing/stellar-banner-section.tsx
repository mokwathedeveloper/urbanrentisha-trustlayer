...
export function StellarBannerSection() {
  return (
    <section id="stellar" className="relative overflow-hidden border-b border-ur-border bg-ur-bg">
      <div className="ur-container relative min-h-[360px] overflow-hidden">
        <Image
        ...
        />
        <div className="absolute inset-0 z-10 bg-ur-bg/70" />

        <div className="relative z-20 flex min-h-[360px] flex-col items-center justify-center gap-8 py-10 lg:flex-row lg:justify-between">
